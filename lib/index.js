...
const createMapOfStationsOfInterest = (opts, stations) => stations
...
const createMapOfParamsOfInterest = (stations, channels) => channels
...
module.exports = async (callback, options) => {
  ...
  try {
    ...
    const stations = createMapOfStationsOfInterest(opts, configuration.config.stations)
    const channels = createMapOfParamsOfInterest(stations, configuration.config.channels)
